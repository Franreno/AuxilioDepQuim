...
CREATE TABLE REESTRUTURACAO_PROFISSIONAL(
    ...
    CONSTRAINT FK_REESTRUTURACAO_PROFISSIONAL FOREIGN KEY(FRENTE,CENTR0)
        REFERENCES FRENTE(NOME,CENTRO)
        ON DELETE CASCADE
);
...
CREATE TABLE VICIOS_DEPENDENTE(
    CPF CHAR(14),
    VICIO VARCHAR(25),
    CONSTRAINT PK_VICIOS_DEPENDENTE PRIMARY KEY(CPF, VICIOS),
...
CREATE TABLE REABILITACAO(
    ...
    CONSTRAINT FK_REABILITACAO2 FOREIGN KEY(FRENTE,CENTRO)
        REFERENCES RESTRUTURACAO_SOCIAL(FRENTE,CENTRO)
        ON DELETE CASCADE,
...
CREATE TABLE EMPREGO_SUPERVISIONADO(
    ...
    LOCAL VARCHAR(65),
    DURACAO NUMBER,
    CONSTRAINT PK_EMPREGO_SUPERVISIONADO(AUXILIADO, FRENTE, CENTRO, EMPRESA_PARCEIRA),
